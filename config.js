...
module.exports = {
    ...
    BOT_NAME:              process.env.BOT_NAME || "RIJU MD",
    OWNER_NUMBER:          process.env.OWNER_NUMBER || "91764934516",
    OWNER_NAME:            process.env.OWNER_NAME || "RIJU BISWAS",
    DESCRIPTION:           process.env.DESCRIPTION || "Riju MD Bot",
    ALIVE_IMG:             process.env.ALIVE_IMG || "https://files.catbox.moe/8ajpxf.jpg",
    LIVE_MSG:              process.env.LIVE_MSG || "Riju MD is active",
    ...
    AUTO_STATUS_MSG:       process.env.AUTO_STATUS_MSG || "Seen by Riju Md",
    ...
    STATUS_MSG:            process.env.STATUS_MSG    || 'RIJU MD 💖 SUCCESSFULLY VIEWED YOUR STATUS',
    ...
    ANTIDELETE_GROUP:      toBool(process.env.ANTIDELETE_GROUP,      false),
    ANTIDELETE_PRIVATE:    toBool(process.env.ANTIDELETE_PRIVATE,    false),
